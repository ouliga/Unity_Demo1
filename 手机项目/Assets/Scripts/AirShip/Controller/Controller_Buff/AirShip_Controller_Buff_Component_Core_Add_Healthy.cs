...
public class AirShip_Controller_Buff_Component_Core_Add_Healthy : AirShip_Controller_Buff_Base
{
    private int _add_Healthy;
    public AirShip_Controller_Buff_Component_Core_Add_Healthy(int add_Healthy)
    {
        _add_Healthy = add_Healthy;
        _buff_Description = $"核心组件增加{add_Healthy}生命值";
    }
